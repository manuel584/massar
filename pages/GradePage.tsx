      ...
      <div className="flex overflow-x-auto p-4 gap-3 no-scrollbar bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700 items-center">
        {sections.map(section => (
          <div
            ...
            role="button"
            tabIndex={0}
            className={`px-6 py-2 rounded-full whitespace-nowrap text-sm font-medium transition-colors relative group flex items-center gap-2 cursor-pointer select-none ${
